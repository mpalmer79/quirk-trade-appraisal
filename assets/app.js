...
<form
  ...
  <div class="utilitybar">
    <div class="left-actions">
      <button type="button" id="decodeVinBtn" class="ghost-btn" aria-live="polite" data-i18n="decodeVinBtn">
        Decode VIN & Prefill
      </button>
        ...
        <div>
          ...
          <div>
            ...
            <div class="phone-wrapper">
              <input id="phone" name="phone" type="tel" inputmode="tel" autocomplete="tel" required placeholder="(###) ###-####" aria-describedby="phoneHint">
            </div>
